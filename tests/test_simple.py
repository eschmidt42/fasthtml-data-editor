...
def test_example(page: Page) -> None:
    ...
    page.get_by_role("textbox", name="30").click()
    page.get_by_role("textbox", name="30").press("ControlOrMeta+a")
    page.get_by_role("textbox", name="30").click()
    page.get_by_role("textbox", name="30").fill("2")
    page.get_by_role("textbox", name="Chicago").click()
    page.get_by_role("textbox", name="Chicago").fill("c")
